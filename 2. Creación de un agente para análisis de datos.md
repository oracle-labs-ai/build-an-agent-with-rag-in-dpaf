...
Si no hay cambios necesarios, simplemente presione el botón **Cloe**

![Botón Start](./AI%20Private%20Agent%20Factory/image%2047.png)
...
- **Tipo de conexión:** Wallet. Adjunta la Wallet descargada previamente.
- **Database alias:** Selecciona el alias terminado en _medium. 
- **Usuario:** `ADMIN`
...
Utiliza la barra de búsqueda para encontrar y seleccionar una tabla que el agente utilizará. El nombre de la tabla corresponde al nombre de alguno de los archivos CSV cargados en el Paso 1 (sin la extensión `.csv`).
...
Una vez seleccionada la tablas, haz clic en el botón **Add New Source** para confirmar la selección y avanzar al siguiente paso.

![Botón Add New Source](./AI%20Private%20Agent%20Factory/dpaf_image17.png)

### Revisión de la configuración del agente

En este paso realizaremos la configuración de un agente. Aquí podemos darle instrucciones y contexto. Según nuestros datos ¿Qué instrucciones podría realizar nuestro agente?
...
![Resumen de configuración del agente](./AI%20Private%20Agent%20Factory/image%2048.png)
...
> ¿Qué preguntas le harías a los datos?
